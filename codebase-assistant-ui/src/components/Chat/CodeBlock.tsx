...
export function CodeBlock({ language, code }: Props) {
  return (
    <div className="my-2 rounded-xl overflow-hidden border border-dark-500">
      <div className="flex items-center justify-between px-3 py-1.5 bg-dark-800 border-b border-dark-500">
